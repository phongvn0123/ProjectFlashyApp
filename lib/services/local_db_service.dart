...
class LocalDbService {
  ...
  Future<void> _seedData(Database db) async {
    ...
    await db.insert('users', {
      'user_id': 1,
      'username': 'admin',
      'email': 'admin@flashly.com',
      'password_hash': 'admin123',
      'full_name': 'Flashly Admin',
      'role': 'admin',
      'created_at': now,
      'updated_at': now,
    });
    ...
    await db.insert('flashcard_sets', {
      ...
      'description': 'Công thức quan trọng',
      'visibility': 'private',
      'created_at': now,
      'updated_at': now,
    });
    await db.insert('flashcard_sets', {
      ...
      'owner_id': 4,
      'title': 'JLPT N3 Kanji',
      'description': '100 chữ Kanji Unit 1',
      'visibility': 'public',
      'created_at': now,
      'updated_at': now,
    });
    ...
    await db.insert('flashcards', {
      'card_id': 2,
      'set_id': 1,
      'front_text': 'Curriculum',
      'back_text': 'Chương trình giảng dạy',
      'order_no': 2,
      'created_at': now,
      'updated_at': now,
    });
    ...
    await db.insert('flashcards', {
      'card_id': 4,
      'set_id': 1,
      'front_text': 'Vocational School',
      'back_text': 'Trường nghề',
      'order_no': 4,
      'created_at': now,
      'updated_at': now,
    });
    ...
    await db.insert('flashcards', {
      ...
      'set_id': 2,
      'front_text': 'Riverpod',
      'back_text': 'Thư viện quản lý state cho Flutter',
      'order_no': 1,
      'created_at': now,
      'updated_at': now,
    });
    await db.insert('flashcards', {
      'card_id': 6,
      'set_id': 2,
      'front_text': 'Clean Architecture',
      'back_text': 'Kiến trúc phân lớp: domain - data - presentation',
      'order_no': 2,
      'created_at': now,
      'updated_at': now,
    });
    await db.insert('flashcards', {
      'card_id': 7,
      'set_id': 3,
      'front_text': 'Bước sóng (λ)',
      'back_text': 'Khoảng cách giữa 2 điểm dao động cùng pha gần nhau nhất',
      'order_no': 1,
      'created_at': now,
      'updated_at': now,
    });
    await db.insert('flashcards', {
      ...
      'set_id': 3,
      'front_text': 'Tần số (f)',
      'back_text': 'Số dao động trong 1 giây, đơn vị Hz',
      'order_no': 2,
      'created_at': now,
      'updated_at': now,
    });
    ...
    await db.insert('quiz_questions', {
      'question_id': 1,
      'quiz_id': 1,
      'question_text': "'Pedagogy' nghĩa là gì?",
    ...
    await db.insert('quiz_questions', {
      'question_id': 2,
      'quiz_id': 1,
      'question_text': "'Curriculum' nghĩa là gì?",
      'question_type': 'single_choice',
      'position': 2,
    });
    await db.insert('quiz_questions', {
      'question_id': 3,
      'quiz_id': 2,
      'question_text': 'StatefulWidget khác StatelessWidget ở điểm nào?',
      'question_type': 'single_choice',
      'position': 1,
    });
    await db.insert('quiz_questions', {
      'question_id': 4,
      'quiz_id': 4,
      'question_text': "Chữ Kanji '学' nghĩa là gì?",
      'question_type': 'single_choice',
      'position': 1,
    });
    ...
    await db.insert('quiz_options', {
      'option_id': 3,
      'question_id': 2,
      'option_text': 'Chương trình giảng dạy',
      'is_correct': 1,
      'display_order': 1,
    });
    await db.insert('quiz_options', {
    ...
    await db.insert('quiz_options', {
      ...
      'question_id': 3,
      'option_text':
          'StatefulWidget có thể thay đổi trạng thái, StatelessWidget thì không',
      'is_correct': 1,
      'display_order': 1,
    });
    await db.insert('quiz_options', {
      'option_id': 6,
      'question_id': 3,
      'option_text': 'Không có gì khác biệt',
      'is_correct': 0,
      'display_order': 2,
    });
    await db.insert('quiz_options', {
    ...
    await db.insert('class_activities', {
      ...
      'target_id': 1,
      'content': 'Giáo viên đã giao bộ thẻ "IELTS Vocabulary - Unit 1"',
      'created_at': now,
    });
    await db.insert('class_activities', {
      'activity_id': 2,
      ...
      'actor_id': 3,
      'type': 'join_class',
      'content': 'Lê Thị An đã tham gia lớp',
      'created_at': now,
    });
    await db.insert('class_activities', {
      'activity_id': 3,
      ...
      'type': 'create_quiz',
      'target_id': 2,
      'content': 'Giáo viên đã tạo Quiz "Flutter Basic"',
      'created_at': now,
    });
    await db.insert('class_activities', {
      'activity_id': 4,
      ...
      'actor_id': 4,
      'type': 'join_class',
      'content': 'Trần Thanh Bình đã tham gia lớp',
      'created_at': now,
    });
  }
